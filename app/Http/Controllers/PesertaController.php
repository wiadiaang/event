...
class PesertaController extends Controller
{
     ...
     public function index()
     {
      ...
      public function post(Request $request)
      {
            ...
            $this->validate($request, [
             ...
             'email_peserta' => 'required|string|max:255',
      ...
      public function getPeserta()
      {
           ...
           $result = Peserta::join('tbl_event', 'tbl_event.event_id', '=', 'tbl_peserta.event_id')
                       ->get(['tbl_peserta.*', 'tbl_event.nama_event']);
         ...
         return DataTables::of($result)
                 ...
                 ->addColumn('qrcode', function ($row) {
                              $qrcode =   QrCode::size(50)->backgroundColor(60, 206, 139)->generate($row->no_peserta) ;
                               
                                   return  $qrcode; })
                 ->addColumn('action', function($row){
                     $actionBtn = ' <div class="d-flex justify-content-evenly">
                                                  <a class="btn btn-primary btn-icon btn-sm rounded-pill"  href="/admin/peserta/view/'. $row->id_peserta.'" role="button">
                                         ...
                                         <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2"  href="/admin/peserta/edit/'. $row->id_peserta.'" role="button">
                                             <span class="btn-inner">
                                                 <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                         ...
                                         <a  class="btn btn-primary btn-icon btn-sm rounded-pill ms-2 delete-confirm" href="" data-id='. $row->id_peserta. ' role="button">
                                             <span class="btn-inner">
                                                 <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 ->rawColumns(['action','photo','qrcode'])
                 ->make(true);
      }
     ...
     public function edit($id)
     {
      ...
      public function view($id)
      {
          ...
          $post =  Peserta::join('tbl_event', 'tbl_event.event_id', '=', 'tbl_peserta.event_id')
                      ->where('tbl_peserta.id_peserta', '=', $id)->first();
                    //    ->get(['tbl_peserta.*', 'tbl_event.nama_event']);

          return view('peserta/view',[
             "title" => "peserta",
             "post" =>  $post,
             ]);
      }
