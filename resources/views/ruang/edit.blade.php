    ...
    <div class="row">
        <div class="col-sm-12 col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('update.ruang',$post->id_ruang) }}"  method="POST" >
                        @csrf    
                        @method('PATCH') 
                        <div class="form-group">
                            <label class="form-label" for="email1101">Tempat Acara:</label>
                            <input name="nama_ruang" value="{{ $post->nama_ruang }}" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="email1101">Alamat:</label>
                            <input name="alamat" type="text" value="{{ $post->alamat }}" class="form-control" id="text">
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <a href="{{ url('/admin/ruang')}}" class="btn btn-danger">Batal</a>
