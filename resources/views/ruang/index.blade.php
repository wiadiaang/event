          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                ...
                <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" >
                  <a href="{{ url('admin/ruang/add') }}" class="btn btn-primary rounded-pill">Tambah Data</a>
             ...
             <div class="card-body">
                ...
                <div class="table-responsive">
                   <table id="ruangan" class="table table-striped">
                      <thead>
                         <tr>
                            <th>No</th>
                            <th>Tempat/ Ruang</th>
