                ...
                <div class="card-body">
                    <form action="{{ route('post.peserta') }}"  method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_peserta" type="text" class="form-control" id="text">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="email1101">Email :</label>
                            <input name="email_peserta" type="email" class="form-control" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="no_hp" type="text" class="form-control" id="text">
                        </div>
                        <div class="form-group">
