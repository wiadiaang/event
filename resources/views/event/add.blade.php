                ...
                <div class="card-body">
                    <form action="{{ route('post.event') }}"  method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_event" type="text" class="form-control" id="text">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="email1101">Tanggal :</label>
                            <input name="tanggal_event" type="date" class="form-control" id="exampleInputdate">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="email1101">Jam :</label>
                            <input name="jam_event" type="time" class="form-control" id="exampleInputtime" >
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="email1101">Kuota :</label>
                            <input name="kuota_event" type="number" class="form-control" id="text">
                        </div>
